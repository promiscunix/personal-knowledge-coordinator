...
- [ ] Add hierarchical daily/weekly/monthly summaries.
- [ ] Add pgvector/embedding support if semantic retrieval needs justify it.
- [ ] Build non-destructive Obsidian importer.
- [ ] Add backup and restore automation.
- [ ] Add OS/database least-privilege agent users.
